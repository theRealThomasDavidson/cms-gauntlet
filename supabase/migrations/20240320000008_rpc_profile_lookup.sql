...
drop function if exists update_ticket_data(uuid, text, text, ticket_status, ticket_priority, uuid, uuid, text);

-- Recreate the function with internal profile lookup
